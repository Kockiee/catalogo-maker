    ...
    return (
        <div className="bg-white !border-4 !border-lightcyan p-4 rounded flex flex-wrap">
            <div className="w-full space-y-2">
                ...
                value="Como deseja receber pedidos ?"
                />
                ...
                <Button onClick={async() => await setCatalogWhatsapp('catalog-maker', catalogId)} disabled={orderForm === 2} size="md" className="bg-neonblue hover:!bg-neonblue/80 focus:ring-jordyblue w-full">Continuar</Button>
            </div>
        </div>
    )
}